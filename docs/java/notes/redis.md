...
![](./images/2023-10-24-18-17-10.png)
...
![](./images/2023-10-24-18-17-12.png)
...
![](./images/2023-10-24-18-17-13.png)
...
- 修改配置文件
  ...
  - 配置文件修改
- 混合持久化方式的加载流程
![](./images/2023-10-24-18-17-14.png)
- 优缺点
...
![](./images/2023-10-24-18-17-16.png)
...
- 对象存储及内部实现
  ...
  - 为什么是44字节？
      ...
      - redisObject = 16字节
      - SDS = 4字节 + 44字节的buf[] 
![](./images/2023-10-24-18-17-17.png)
- SDS 内部结构
- SDS与c字符串的优点
...
- 散列表（哈希表）基本信息
  ...
  - 散列表存储方式及哈希冲突解决思路
    - 开放寻址法
      - 线性探测
![](./images/2023-10-24-18-17-18.png)
    - 链表法
      - 数组+链表方式实现
![](./images/2023-10-24-18-17-19.png)
...
- dict原理
  - 存储原理
    - ziplist压缩列表
![](./images/2023-10-24-18-17-20.png)
    - 编码转换条件
      - `键值对数量小于512` && `所有键值对的key和value的长度都小于64字节` 时使用ziplist；
      - 否则就使用hashtable
    - hashtable
![](./images/2023-10-24-18-17-22.png)
...
![](./images/2023-10-24-18-17-23.png)
    - 新增
...
- 内部实现原理
  - skiplist
![](./images/2023-10-24-18-17-24.png)
  - 跳跃表基于单链表加索引的方式实现
  - 跳跃表以空间换时间的方式提升了查找速度
...
![](./images/2023-10-24-18-17-25.png)
...
- 执行淘汰的机制
![](./images/2023-10-24-18-17-27.png)
- lru的原理
...
- 基本原理
![](./images/2023-10-24-18-17-28.png)
