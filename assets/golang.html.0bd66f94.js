import{c as s,a,F as n,e as l,o as r}from"./app.98de23b3.js";import{_ as i}from"./plugin-vue_export-helper.21dcd24c.js";const t={},u=l(`<h2 id="\u5B89\u88C5\u8FC7\u7A0B" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5\u8FC7\u7A0B" aria-hidden="true">#</a> \u5B89\u88C5\u8FC7\u7A0B</h2><ul><li><p>\u4E0A\u4F20\u81F3/opt/packages</p></li><li><p>\u52A0\u538B</p></li></ul><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>tar zxf go*
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><hr>`,14),d=["src"];function p(e,c){return r(),s(n,null,[u,a("img",{style:{border:"1px red solid",display:"block",margin:"0 auto"},src:e.$withBase("/qrcode.jpg"),alt:"\u5FAE\u4FE1\u516C\u4F17\u53F7"},null,8,d)],64)}var m=i(t,[["render",p],["__file","golang.html.vue"]]);export{m as default};
