import{c as n,a as s,F as l,e as a,o as r}from"./app.98de23b3.js";import{_ as i}from"./plugin-vue_export-helper.21dcd24c.js";const t={},u=a(`<h2 id="\u5B89\u88C5\u8FC7\u7A0B" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5\u8FC7\u7A0B" aria-hidden="true">#</a> \u5B89\u88C5\u8FC7\u7A0B</h2><ul><li>\u68C0\u67E5ruby\u662F\u5426\u5B89\u88C5</li></ul><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>ruby -v
...
jekyll -v
	\u8F93\u51FA\uFF1A jekyll 3.8.3
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><hr>`,16),d=["src"];function c(e,p){return r(),n(l,null,[u,s("img",{style:{border:"1px red solid",display:"block",margin:"0 auto"},src:e.$withBase("/qrcode.jpg"),alt:"\u5FAE\u4FE1\u516C\u4F17\u53F7"},null,8,d)],64)}var o=i(t,[["render",c],["__file","jekyll.html.vue"]]);export{o as default};
