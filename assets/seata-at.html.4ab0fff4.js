import{c as s,a,F as e,e as p,o as t}from"./app.65f1b23a.js";import{_ as r}from"./plugin-vue_export-helper.21dcd24c.js";var l="/assets/2023-10-24-18-12-16.e54d163f.png",c="/assets/2023-10-24-18-12-17.656840fa.png",o="/assets/2023-10-24-18-12-18.dc52202b.png",i="/assets/2023-10-24-18-12-20.a54ed363.png",u="/assets/2023-10-24-18-12-21.706e8c91.png",b="/assets/2023-10-24-18-12-22.c5357de8.png",d="/assets/2023-10-24-18-12-23.7c48c696.png",m="/assets/2023-10-24-18-12-24.ee4a5ef3.png",g="/assets/2023-10-24-18-12-26.53ecd344.png";const k={},T=p(`<h2 id="\u4F7F\u7528\u573A\u666F" tabindex="-1"><a class="header-anchor" href="#\u4F7F\u7528\u573A\u666F" aria-hidden="true">#</a> \u4F7F\u7528\u573A\u666F</h2><p>\u4E3E\u4E00\u4E2A\u7B80\u5355\u7684\u5E94\u7528\u573A\u666F\uFF1A\u7535\u5546\u7CFB\u7EDF\u4E2D\uFF0C\u4E00\u4E2A\u7528\u6237\u53D1\u8D77\u8D2D\u4E70\u5546\u54C1\u7684\u52A8\u4F5C\uFF0C\u540E\u7AEF\u4E1A\u52A1\u903B\u8F91\u662F</p><ul><li>\u6263\u51CF\u5E93\u5B58</li><li>\u6263\u51CF\u4E2A\u4EBA\u8D26\u6237\u4E0A\u7684\u4F59\u989D</li><li>\u521B\u5EFA\u4E00\u4E2A\u8BA2\u5355</li></ul><p>\u53EA\u8981\u4E0A\u9762\u6709\u4E00\u4E2A\u6B65\u9AA4\u6CA1\u6709\u6267\u884C\u6210\u529F\uFF0C\u5C31\u56DE\u6EDA\u5DF2\u7ECF\u6267\u884C\u6210\u529F\u7684\u5176\u4ED6\u6B65\u9AA4\u3002\u4E3A\u4E86\u6A21\u62DF\u5206\u5E03\u5F0F\u4E8B\u52A1\u7684\u6548\u679C\uFF0C\u6211\u4EEC\u91C7\u7528\u521B\u5EFA\u4E09\u4E2A\u5FAE\u670D\u52A1\u7684\u65B9\u5F0F\u5B9E\u73B0\u3002</p><ol><li>seata-at-storage \u5E93\u5B58\u670D\u52A1</li><li>seata-at-account \u8D26\u6237\u670D\u52A1</li><li>seata-at-order \u8BA2\u5355\u670D\u52A1</li></ol><p>\u6240\u4EE5\u4E0A\u9762\u7684\u4E1A\u52A1\u903B\u8F91\u5C31\u53D8\u6210\u4E86\uFF0C\u7528\u6237\u53D1\u8D77\u4E00\u4E2A\u8D2D\u4E70\u5546\u54C1\u7684\u670D\u52A1\uFF0C\u76F4\u63A5\u8C03\u7528\u540E\u7AEF \u8BA2\u5355\u670D\u52A1 \uFF0C\u7531\u8BA2\u5355\u670D\u52A1\u5206\u522B\u8C03\u7528 \u5E93\u5B58\u670D\u52A1 \u5B8C\u6210\u6263\u51CF\u5E93\u5B58\u529F\u80FD\uFF0C\u7136\u540E\u518D\u8C03\u7528 \u8D26\u6237\u670D\u52A1 \u5B8C\u6210\u6263\u51CF\u8D26\u6237\u91D1\u989D\u529F\u80FD\uFF0C\u6700\u540E\u672C\u5730\u751F\u6210\u4E00\u4E2A\u8BA2\u5355\u3002</p><p>\u8FD9\u91CC\u6211\u4EEC\u9700\u8981\u4E00\u4E2A\u6CE8\u518C\u4E2D\u5FC3\uFF0C\u628A\u4E09\u4E2A\u670D\u52A1\u6CE8\u518C\u5230\u4E0A\u9762\uFF0C\u8FD9\u6837\u914D\u5408OpenFeign\u5B8C\u6210\u76F8\u4E92\u8C03\u7528\uFF0C\u6B64\u5916\u6211\u4EEC\u8FD8\u9700\u8981MySQL\u4F5C\u4E3A\u6570\u636E\u5B58\u50A8\uFF0C\u6700\u540E\u6211\u4EEC\u9700\u8981Seata\u4F5C\u4E3A\u6211\u4EEC\u7684\u4E8B\u52A1\u7BA1\u7406\u5668\u3002</p><h2 id="\u642D\u5EFAseata-at-storage\u670D\u52A1\u6A21\u5757" tabindex="-1"><a class="header-anchor" href="#\u642D\u5EFAseata-at-storage\u670D\u52A1\u6A21\u5757" aria-hidden="true">#</a> \u642D\u5EFAseata-at-storage\u670D\u52A1\u6A21\u5757</h2><ol><li>\u5148\u521B\u5EFA\u6570\u636E\u5E93</li></ol><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>-- \u4ED3\u50A8
...
public boolean createOrder(String userId, Long productId, Long num) {
  ...
  registry:
    ...
    nacos:
      ...
      username: nacos
      password: nacos
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br></div></div><ol start="3"><li>\u521B\u5EFASeata\u670D\u52A1\u7AEF\u914D\u7F6E\uFF0C\u8FD9\u91CC\u8981\u7279\u522B\u6CE8\u610F\uFF1A\u503C\u5747\u4E3Adefault\u3002</li></ol><p><img src="`+i+'" alt="" loading="lazy"></p><p><img src="'+u+'" alt="" loading="lazy"></p><p><img src="'+b+'" alt="" loading="lazy"></p><p><img src="'+d+`" alt="" loading="lazy"></p><ol start="4"><li>\u4FEE\u6539\u4E1A\u52A1\u4EE3\u7801\uFF0C\u5728\u8BA2\u5355\u6A21\u5757\u4E2D\u8BBE\u7F6E\u751F\u6210\u8BA2\u5355\u7684\u65B9\u6CD5\u4E3A\u5168\u5C40\u4E8B\u52A1</li></ol><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>@Override
@GlobalTransactional
public boolean createOrder(String userId, Long productId, Long num) {
    // 1. \u6263\u51CF\u5E93\u5B58
    storageFeignClient.deduct(productId, num);
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><ol start="5"><li>\u542F\u52A8\u6D4B\u8BD5</li></ol><p><img src="`+m+'" alt="" loading="lazy"></p><p><img src="'+g+'" alt="" loading="lazy"></p><hr>',52),N=["src"];function E(n,y){return t(),s(e,null,[T,a("img",{style:{border:"1px red solid",display:"block",margin:"0 auto"},src:n.$withBase("/qrcode.jpg"),alt:"\u5FAE\u4FE1\u516C\u4F17\u53F7"},null,8,N)],64)}var M=r(k,[["render",E],["__file","seata-at.html.vue"]]);export{M as default};
